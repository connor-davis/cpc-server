          ...
          <div id="home" className="flex flex-col">
            ...
            <div className="flex flex-col justify-center items-center md:p-10 space-y-5">
              <div className="flex text-lg px-5 md:px-20 text-center">
                ...
                communicate on a secure platform. Let your community stay
                updated with whats happening.
              </div>
            </div>
          </div>
          ...
          <div id="why" className="flex flex-col">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center p-5 md:p-10 space-y-5 md:space-x-5 md:space-y-0">
              <div className="flex flex-col shadow-md md:shadow-xl rounded-md space-y-6 p-6 md:w-1/3 h-full">
                ...
                <div className="flex">
                  <div className="flex flex-col text-lg">
                    Messaging in CPC happens in real-time, making sure that you
                    and your users stay in touch as things happen.
                  </div>
                </div>
              </div>
              <div className="flex flex-col shadow-md md:shadow-xl rounded-md space-y-6 p-6 md:w-1/3 h-full">
                ...
                <div className="flex">
                  <div className="flex flex-col text-lg">
                    The UI of CPC is built to be easy and efficient to use,
                    making sure that anyone can get on and use the app without
              ...
              <div className="flex flex-col shadow-md md:shadow-xl rounded-md space-y-6 p-6 md:w-1/3 h-full">
                ...
                <div className="flex">
                  <div className="flex flex-col text-lg">
                    The CPC server is built to manage users efficiently and
                    reliably and also makes sure that admins can keep in touch
                    with users while being able to let the community know whats
                    happening out there.
                  </div>
                </div>
              </div>
          ...
          <div id="licence" className="flex flex-col">
            ...
            <div className="flex flex-col justify-center items-center md:p-10 space-y-5">
              <div className="flex text-lg px-5 md:px-20 text-center">
                ...
                platform will be hosted on as well as the mobile app that your
                users will be able to download to keep things updated.
              </div>
            </div>
          </div>
